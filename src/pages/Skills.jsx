...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Python", "C++"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React" ,"Express Js"] },
  ...
  [
    ...
    {
      title: "Soft Skills",
      items: ["Leadedrship","Teamwork", "Problem Solving", "Creativity", "Adaptability", "Communication"],
    },
  ],
];

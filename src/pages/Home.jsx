...
// 🖼️ Import Assets
import photo from '../../public/myphoto.jpeg'
    ...
    >
      ...
      >
        ...
        >
          ...
          >
           | Full Stack Developer | Prompt Engineer | Tech Explorer | Data Analyst |
          </p>
          ...
          >
            {[ 
              { label: '📍 Location', value: 'Amethi,Uttar Pradesh,India' },
              { label: '💼 Expertise', value: 'DSA, Full Stack Development,DA' },
              { label: '📧 Contact', value: 'mohdsarfarazkhan237@gmail.com' },
            ].map((info, i) => (
              <motion.div
                key={i}
